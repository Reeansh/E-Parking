...
<body>
    ...
    <!-- Page Content -->
    <div class="container">
    <center><h3 class="mt-4">UNIVERSITAS TEKNOLOGI DIGITAL INDONESIA</h3></center>
    <center><p>Setiap Hari Pukul 08.00 Wib - 17.00 WIB</p></center>
        
        <h3 class="mt-4">Daftar Parkir Kendaraan  | Repost by <a href='https://www.instagram.com/tareeansh_/' title='Taree Anisah' target='_blank'>Taree Anisah</a>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4">
                <div class="card border-success mb-3">
                    <div class="card-header bg-transparent border-success">Nomor Polisi : <?= $kendaraan['nomor_polisi']; ?>
                        <div id="tombol">
                    ...
                    <div class="card-footer">
                        <small class="text-muted">Tiket Parkir Diharapkan Jangan Hilang sebagai Tanda Bukti!</small>
                    </div>
                </div>
            </div>
            <?php endwhile; ?>
